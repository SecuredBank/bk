...
export default function Home() {
  return (
    <div className="min-h-screen bg-background cyber-grid relative flex flex-col overflow-hidden">
      ...
      <footer className="py-12 mt-24 border-t border-accent/10 bg-background/50">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Next-generation banking security powered by AI-driven fraud detection and real-time monitoring.
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-foreground mb-4">Product</h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><Link href="/dashboard" className="hover:text-accent transition-colors">Customer Portal</Link></li>
                <li><Link href="/admin/dashboard" className="hover:text-accent transition-colors">Analyst Dashboard</Link></li>
                <li><Link href="/transfer" className="hover:text-accent transition-colors">Secure Transfers</Link></li>
                <li><Link href="/admin/logs" className="hover:text-accent transition-colors">Transaction Logs</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold text-foreground mb-4">Security</h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><span className="hover:text-accent transition-colors cursor-pointer">Fraud Detection</span></li>
                <li><span className="hover:text-accent transition-colors cursor-pointer">Biometric Auth</span></li>
                <li><span className="hover:text-accent transition-colors cursor-pointer">Risk Analysis</span></li>
                <li><span className="hover:text-accent transition-colors cursor-pointer">Threat Intelligence</span></li>
              </ul>
            </div>
            <div>
          ...
          <div className="pt-8 border-t border-accent/5 flex flex-col md:flex-row items-center justify-between">
            <p className="text-sm text-muted-foreground">© 2025 SecureBank Defense Systems. All rights reserved.</p>
            <div className="flex items-center gap-4 mt-4 md:mt-0">
              <span className="text-xs text-muted-foreground">Powered by</span>
              <span className="text-xs font-semibold text-accent">Next.js • React • TypeScript</span>
            </div>
          </div>
        </div>
      </footer>
