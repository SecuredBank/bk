...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden" style={{ backgroundImage: "url('/auth-bg.svg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
            {/* Background Effects */}
            ...
            <div className="absolute inset-0 bg-[url('/bg-pattern.svg')] opacity-20 pointer-events-none" />
